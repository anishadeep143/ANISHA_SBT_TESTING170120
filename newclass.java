...
WebDriver driver=new ChromeDriver();
		...
		driver.findElement(By.className("nav-input")).click();
		driver.findElement(By.id("pdagDesktopSparkleDescription1")).click();
		driver.get("https://www.amazon.in/dp/B07HGH82LT?aaxitk=8SPidTfDvLonCtSKQv3.jg&pd_rd_i=B07HGH82LT&pf_rd_p=2e3653de-1bdf-402d-9355-0b76590c54fe&hsa_cr_id=7561426100802&sb-ci-n=productDescription&sb-ci-v=Samsung%20Galaxy%20M10s%20(Metallic%20Blue%2C%203GB%20RAM%2C%20Super%20AMOLED%20Display%2C%2032GB%20Storage%2C%204000mAH%20Battery)");
		driver.findElement(By.id("add-to-cart-button")).click();
